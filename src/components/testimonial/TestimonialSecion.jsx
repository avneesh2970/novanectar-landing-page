...
const TestimonialCard = ({ name, role, content }) => {
  return (
    <div
      className={`relative bg-white rounded-xl p-6 pt-10 shadow-lg h-full flex flex-col`}
    >
      {/* Quote icon */}
...
const TestimonialSection = () => {
  ...
  const goToPage = (pageIndex, direction) => {
    ...
    >
      ...
      <div className="relative w-full min-h-screen flex flex-col justify-center">
        ...
        <div className="relative z-10 text-center mb-12 px-4 mt-28">
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl font-semibold text-gray-800 mb-3`}
          >
