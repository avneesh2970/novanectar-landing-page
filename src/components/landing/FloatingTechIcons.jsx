...
import flutter from "../../assets/icons/dock.png"

import express from "../../assets/icons/express.png"
import nextjs from "../../assets/icons/dock2.png"
...
const TechIcon = memo(({ icon, index, iconRef, isVisible }) => (
  <div
    key={icon.alt}
    ref={iconRef}
